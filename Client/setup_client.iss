...
LicenseFile=D:/PROJECT/jammerNetz/JammerNetz/Client/redist/agpl-3.0.txt
; Remove the following line to run in administrative install mode (install for all users.)
PrivilegesRequired=lowest
OutputDir=D:/PROJECT/jammerNetz/JammerNetz/Client
...
[Files]
Source: "D:/PROJECT/jammerNetz/JammerNetz/Client\Release\JammerNetzClient.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:/PROJECT/jammerNetz/JammerNetz/Client\Release\tbb.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:/PROJECT/jammerNetz/JammerNetz/_deps/vcredist-subbuild/vcredist-populate-prefix/src\{#VCRedistFileName}"; DestDir: {tmp}; Flags: dontcopy
